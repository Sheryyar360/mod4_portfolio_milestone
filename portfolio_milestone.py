...
def item_cost(product):
    product_total = product.item_quantity * product.item_price
    return product_total

print('{} {} @ ${:.2f} = ${:.2f}'.format(product1.item_quantity, product1.item_name, product1.item_price, item_cost(product1)))
print('{} {} @ ${:.2f} = ${:.2f}'.format(product2.item_quantity, product2.item_name, product2.item_price, item_cost(product2)))
print('Grand total = ${:.2f}'.format((item_cost(product1) + item_cost(product2))))
